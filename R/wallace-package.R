...
#' Website: \url{https://ecologistatwork.com/})
...
#' Type: \tab Package\cr
#' Version: \tab 1.1.3-1.3\cr
#' Date: \tab 2025-10-19\cr
#' License: \tab GNU 3.0\cr
#' }
#'
#' @references Kass J.M., Pinilla-Buitrago G.E., Vilela B., Aeillo-Lammens M.E., Muscarella R., Merow C., and Anderson R.P. (2022) \emph{Wallace}: A modular platform for reproducible ecological modeling. Version 1.1.3-1.3
